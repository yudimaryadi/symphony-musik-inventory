...
<head>
  ...
  <title>Aplikasi Inventory : TOKO IDUY JAYA SENTOSA</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="col-md-6">
      <div class="panel panel-dark" style="margin-top:120px;">
        <div class="panel-heading" style="padding:20px;">
          <div class="col-md-1"></div>

          <div style="font-size:150%;"><img src="img/logo 1.png" alt="yudi" style="width: 30px;" />&nbsp;<strong>Symphonie Musik Iduy Jaya Sentosa</strong></S></div>
          <div class="col-md-1"></div>
          ...
          <form method="post">
            <div class="form-group">
              <div class="input-group" style="margin:10px 2px;">
                ...
                <input type="text" name="tuser" class="form-control" placeholder="kasir" maxlength="20" required value="<?php echo @$_POST['tuser']; ?>" tabindex="0" autofocus autocomplete="on">
              </div>
            </div>
            <div class="form-group">
              <div class="input-group col-md-12" style="margin:10px 2px;">
                ...
                <input type="password" name="tpass" id="password" class="form-control" placeholder="kasir123" tabindex="0" maxlength="30" required value="<?php echo @$_POST['tpass']; ?>" autocomplete="off">
              </div>
            </div>
            <!-- 	<div class="form-group">
							<div class="input-group" style="margin:10px 2px;">
                  ...
                  ?>
										<option value="<?php echo $x['0']; ?>" <?php if ($x['0'] == @$_POST['level']) {
                                                              echo "selected";
                                                            } ?>><?php echo $x['1']; ?></option>
									<?php } ?>
								</select>
            ...
            <div class="col-md-3"></div>
            <button type="submit" name="blogin" class="btn btn-dark btn-block col-md-6">LOGIN</button>
          </form>
        </div>
        <div class="panel-footer" align="center">
          &copy;J3D418193 - Yudi Maryadi
        </div>
      </div>
    </div>
